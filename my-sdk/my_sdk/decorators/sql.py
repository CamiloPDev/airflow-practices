from typing import ClassVar, Callable, Collection, Mapping, Any
...
class _SQLDecoratedOperator(DecoratedOperator, SQLExecuteQueryOperator):
    ...
    def execute(self, context: Context) -> Any:
        ...
        self.sql = self.python_callable(**kwargs)

        if not isinstance(self.sql, str) or self.sql.strip() == "":
            raise TypeError("The decorated function must return a non-empty SQL string.")
